...
/** 
 * DAO for table "FAVORITE_MUSIC_NOTE".
*/
public class FavoriteMusicNoteDao extends AbstractDao<FavoriteMusicNote, Long> {

    public static final String TABLENAME = "FAVORITE_MUSIC_NOTE";

    /**
     * Properties of entity FavoriteMusicNote.<br/>
    ...
    */
    ...
    public FavoriteMusicNoteDao(DaoConfig config) {
        super(config);
    }
    
    public FavoriteMusicNoteDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FAVORITE_MUSIC_NOTE\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FAVORITE_MUSIC_NOTE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, FavoriteMusicNote entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(FavoriteMusicNote entity) {
    ...
    /** @inheritdoc */
    @Override
    public FavoriteMusicNote readEntity(Cursor cursor, int offset) {
        FavoriteMusicNote entity = new FavoriteMusicNote( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, FavoriteMusicNote entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(FavoriteMusicNote entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
