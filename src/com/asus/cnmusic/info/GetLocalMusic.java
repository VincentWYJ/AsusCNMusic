...
public class GetLocalMusic {
    ...
    public static List<LocalMusic> getLocalMusic(Context context, String selection, String[] selectionArgs, String sortOrder) {
        List<LocalMusic> localMusicList = new ArrayList<LocalMusic>();
        ...
        for (cursor.moveToFirst(); !cursor.isAfterLast(); cursor.moveToNext()) {
            ...
            LocalMusic audio = new LocalMusic(bundle);
            localMusicList.add(audio);
        }
        
        cursor.close();
        
        Collections.sort(localMusicList, LocalMusicUtils.comparatorLocalMusic);
